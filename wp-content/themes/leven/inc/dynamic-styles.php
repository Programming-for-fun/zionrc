<?php
/**
 * Leven Theme Editor Styles
 *
 */

function leven_theme_settings_css() {
	...
	$page_titles_styles = '
	    ...
	    border-top: 2px solid ' . $cp_general_borders_color . ';
	    border-bottom: 2px solid ' . $cp_general_borders_color . ';
	    line-height: 1.2;
	...
	return apply_filters( 'leven_theme_settings_css', $editor_css );
}
