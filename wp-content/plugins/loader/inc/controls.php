...
if( class_exists( 'WP_Customize_Control' ) ) {
  class Loader_Customize_Range extends WP_Customize_Control {
	...
	*/
	...
	// Enable smooth scrolling setting
	$wp_customize->add_setting( 'smooth_scroll',
	   array(
	      'default' => false,
	      'transport' => 'refresh',
	      'sanitize_callback' => 'loader_sanitize_checkbox'
	...
	$wp_customize->add_control( 'smooth_scroll', array(
	  ...
	  'section' => 'loader_settings',
	  'label' => __( 'Smooth Scrolling', 'loader' ),
	  'description' => __( 'Smooth scrolling effect on web browser.', 'loader' ),
      'description_hidden' => false, 
	) );
	...
	*/
	...
	// Loader custom html setting
	$wp_customize->add_setting( 'loader_custom_html' , array(
	    'default'     => '',
	    'transport'   => 'refresh',
	...
	// Loader custom html control
	$wp_customize->add_control( 'loader_custom_html', array(
	  'type' => 'textarea',
		'label'        => 'Custom HTML',
		'section'    => 'loader_customs',
		'settings'   => 'loader_custom_html',
	 ) );


	// Loader custom css setting
	$wp_customize->add_setting( 'loader_custom_css' , array(
	    'default'     => '',
	    'transport'   => 'refresh',
	...
	// Loader custom css control
	$wp_customize->add_control( 'loader_custom_css', array(
	  'type' => 'textarea',
		'label'        => 'Custom CSS',
		'section'    => 'loader_customs',
		'settings'   => 'loader_custom_css',
	 ) );
	...
	*/
	...
	// Scrolling Frame Rate Setting
	
	$wp_customize->add_setting( 'loader_scroll_frame',
	   array(
	      'default' => '150',
	      'transport' => 'refresh',
	      'sanitize_callback' => 'sanitize_text_field'
	 ...
	 // Scrolling Frame Rate Control

	$wp_customize->add_control( new WP_Customize_Control(
	 $wp_customize, 
	 'loader_scroll_frame', 
	 array(
	    'label'      => __( 'Frame Rate (Hz)', 'loader' ), 
	    'description' => __( 'Recommended: 150', 'loader' ),
	    'settings'   => 'loader_scroll_frame', 
	    'priority'   => 10,
	    'section'    => 'loader_scroll',
	    'type'    => 'number'
	)
	) );


	// Scrolling Animation Duration Setting
	
	$wp_customize->add_setting( 'loader_scroll_dur',
	   array(
	      'default' => '400',
	      'transport' => 'refresh',
	      'sanitize_callback' => 'sanitize_text_field'
	 ...
	 // Scrolling Animation Duration Control

	$wp_customize->add_control( new WP_Customize_Control(
	 $wp_customize, 
	 'loader_scroll_dur', 
	 array(
	    'label'      => __( 'Scrolling Animation Duration (ms)', 'loader' ), 
	    'description' => __( 'Recommended: 400', 'loader' ),
	    'settings'   => 'loader_scroll_dur', 
	    'priority'   => 10,
	    'section'    => 'loader_scroll',
	    'type'    => 'number'
	)
	...
	// Scrolling Step Size Setting
	
	$wp_customize->add_setting( 'loader_scroll_step',
	   array(
	      'default' => '100',
	      'transport' => 'refresh',
	      'sanitize_callback' => 'sanitize_text_field'
	 ...
	 // Scrolling Step Size Control

	$wp_customize->add_control( new WP_Customize_Control(
	 $wp_customize, 
	 'loader_scroll_step', 
	 array(
	    'label'      => __( 'Scrolling Step Size (px)', 'loader' ), 
	    'description' => __( 'Recommended: 100', 'loader' ),
	    'settings'   => 'loader_scroll_step', 
	    'priority'   => 10,
	    'section'    => 'loader_scroll',
	    'type'    => 'number'
	)
	...
	// Enable Keyboard Scroll Effect setting
	$wp_customize->add_setting( 'enable_kb_scroll',
	   array(
	      'default' => true,
	      'transport' => 'refresh',
	      'sanitize_callback' => 'loader_sanitize_checkbox'
	...
	// Enable Keyboard Scroll Effect control
	$wp_customize->add_control( 'enable_kb_scroll', array(
	  'type' => 'checkbox',
	  'settings'   => 'enable_kb_scroll', 
	  'section' => 'loader_scroll',
	  'label' => __( 'Keyboard Scroll Effect', 'loader' ),
	  'description' => __( 'Enable effect on keyboard arrow key scroll.', 'loader' ),
      'description_hidden' => false, 
	) );
	...
	// Keyboard Step Size Setting
	
	$wp_customize->add_setting( 'loader_scroll_step_kb',
	   array(
	      'default' => '50',
	      'transport' => 'refresh',
	      'sanitize_callback' => 'sanitize_text_field'
	 ...
	 // Keyboard Step Size Control

	$wp_customize->add_control( new WP_Customize_Control(
	 $wp_customize, 
	 'loader_scroll_step_kb', 
	 array(
	    'label'      => __( 'Keyboard Step Size (px)', 'loader' ), 
	    'description' => __( 'Recommended: 50', 'loader' ),
	    'settings'   => 'loader_scroll_step_kb', 
	    'priority'   => 10,
	    'section'    => 'loader_scroll',
	    'type'    => 'number'
	)
	...
	// Backend Scroll Effect setting
	$wp_customize->add_setting( 'enable_kb_scroll_admin',
	   array(
	      'default' => false,
	      'transport' => 'refresh',
	      'sanitize_callback' => 'loader_sanitize_checkbox'
	...
	// Backend Scroll Effect control
	$wp_customize->add_control( 'enable_kb_scroll_admin', array(
	  'type' => 'checkbox',
	  'settings'   => 'enable_kb_scroll_admin', 
	  'section' => 'loader_scroll',
	  'label' => __( 'Scroll Effect on Backend', 'loader' ),
	  'description' => __( 'Enable effect on WordPress admin panel.', 'loader' ),
      'description_hidden' => false, 
	) );